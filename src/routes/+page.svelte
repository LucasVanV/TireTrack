		...
		>
			<div>
				...
				<p class="mt-7 max-w-2xl text-lg leading-8 text-black/65 md:text-xl">
					TireTrack transforme le SCANDIAG® en outil IoT de traçabilité pneus : scan code-barres à
					la réception, contrôle laser de l’état, historique d’usure et aide à la décision avant ou
					après chaque pose.
				</p>
				...
				<div class="mt-10 flex flex-col gap-4 sm:flex-row">
					<a
						href={resolve('/demo')}
						class="rounded-sm bg-[#d6001c] px-7 py-4 text-center font-black uppercase tracking-wide text-white shadow-lg shadow-red-900/10 transition hover:-translate-y-0.5 hover:bg-[#b80018]"
					>
			...
			<div class="relative">
				<div class="relative border border-black/10 bg-white p-5 shadow-2xl">
					<div class="mb-4 flex items-center justify-between">
						<div>
							<p class="text-xs font-black uppercase tracking-[0.22em] text-black/40">Vue écurie</p>
							...
							<div class="grid gap-3">
								<div>
									...
									<div class="grid grid-cols-2 gap-2">
										{#each positions.slice(0, 2) as position (position.label)}
											<div class="bg-white/[0.06] p-3">
								...
								<div>
									...
									<div class="grid grid-cols-2 gap-2">
										{#each positions.slice(2, 4) as position (position.label)}
											<div class="bg-white/[0.06] p-3">
												<div class="flex items-start justify-between gap-2">
													<div>
														<p class="text-[10px] font-black uppercase text-white/35">
		...
		<div class="mx-auto max-w-6xl">
			...
			<div class="mt-12 grid gap-5 md:grid-cols-4">
				<div class="border border-black/10 bg-[#f4f4f4] p-6">
					...
					<p class="mt-3 leading-7 text-black/60">
						À la réception, le code-barres du pneu ou du train est lu grâce à la caméra du boîtier.
					</p>
				</div>
				...
				<div class="border border-black/10 bg-[#f4f4f4] p-6">
					...
					<p class="mt-3 leading-7 text-black/60">
						Chaque pneu est associé à une position : avant gauche, avant droit, arrière gauche ou
						arrière droit.
					</p>
				</div>
				...
				<div class="border border-black/10 bg-[#f4f4f4] p-6">
					...
					<p class="mt-3 leading-7 text-black/60">
						L’évolution d’usure est historisée avec graphiques, statuts et recommandations d’équipe.
					</p>
				</div>
			</div>
			...
			<div class="mt-16 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
				<div class="border border-black/10 bg-[#111] p-6 text-white">
					<p class="text-sm font-black uppercase tracking-[0.25em] text-white/40">Workflow</p>

					<div class="mt-6 space-y-4">
						<div class="flex gap-4">
							<div
								class="flex h-9 w-9 shrink-0 items-center justify-center bg-[#d6001c] font-black"
							>
								1
							</div>
							<div>
						...
						<div class="flex gap-4">
							...
							<div>
								...
								<p class="mt-1 text-sm leading-6 text-white/55">
									L’équipe sait si le train est OK, à surveiller, à réserver aux essais ou à
									remplacer.
								</p>
							</div>
						</div>
				...
				<div class="border border-black/10 bg-[#f4f4f4] p-6">
					<div class="flex items-end justify-between gap-4">
						<div>
							<p class="text-sm font-black uppercase tracking-[0.25em] text-black/40">Évolution</p>
					...
					<div class="mt-8 border border-black/10 bg-white p-5">
						<div
							class="mb-4 flex items-center justify-between text-xs font-black uppercase text-black/40"
						>
					...
					<p class="mt-5 text-sm leading-7 text-black/60">
						Chaque scan enrichit l’historique du train : contexte, position sur la voiture, niveau
						d’usure, état visuel et recommandation. L’objectif est de rendre la décision de
						réutilisation plus fiable et traçable.
					</p>
				</div>
			</div>
		</div>
